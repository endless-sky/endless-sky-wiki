...
Once you have set a hyperspace route, press the hyperspace key ('J' by default) to begin travel. Your hyperdrive cannot engage unless your ship is nearly at a standstill, so the autopilot will first bring you to a stop, then fire the hyperdrive. As with the landing autopilot, you can stop the hyperspace jump by pressing any other movement key, up until the point when the hyperdrive fires. But once is fires, you cannot disengage it until you have reached your destination system.
