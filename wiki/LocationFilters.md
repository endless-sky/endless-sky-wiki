...
```html
	...
	[<modifier>] system <name>...
		<name>...
	[<modifier>] government [source] <name>...
		<name>...
	[<modifier>] ally [source] <name>...
		<name>...
	[<modifier>] hostile [source] <name>...
		<name>...
...
```html
[(not | neighbor)] government [source] <name>...
	<name>...
```
...
```html
[(not | neighbor)] ally [source] <name>...
	<name>...
```

Introduced in **v. 0.11.1**, the planet must be in (or must not be in, or must neighbor) a system owned by a government having a positive relationship to any of the given government(s).

```html
[(not | neighbor)] hostile [source] <name>...
	<name>...
```

Introduced in **v. 0.11.1**, the planet must be in (or must not be in, or must neighbor) a system owned by a government having a negative relationship to any of the given government(s).

Introduced in **v. 0.11.1**, if this is a destination filter and `source` is one of the listed names, the filter will match the government determined by the source filter.
