...
While the player is an extraordinary individual within the universe, seemingly capable of doing things that no other human (or even sentient being within the universe) can done, it is important to note that the player is not the center of this universe. All things do not rotate around the player. Instead, the player is simply an actor on the stage of this universe; an important one, but not the sole mover of all things. This is to say that there are things outside of the player's control, and there are certain events that will happen no matter the player's decisions.
