...
* `"hull"`: maximum hull strength. A ship is disabled when either it is reduced to 15% hull, or to the minimum of 45% hull and 10 / &radic;(hull). (That is, small ships are disabled at 45%, and large ones at 15%.)
